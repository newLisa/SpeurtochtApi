...
class PostController extends FOSRestController
{
	...
	*/
	public function putAction(Request $request)
	{
		...
		//dd($requestJson);
		$quest = $this->getDoctrine()->getRepository('AppBundle:Speurtocht')->find($requestJson['quest']['id']);
		...
		foreach ($requestJson['markers'] as $jsonMarker) {
			$marker = $this->getDoctrine()->getRepository('AppBundle:Marker')->find($jsonMarker['id']);
			$question = $this->getDoctrine()->getRepository('AppBundle:Vraag')->find($jsonMarker['questions']['id']);
